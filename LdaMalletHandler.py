...
class LdaMalletHandler:
    ...
    def run_model(self, model_name, corpus, num_topics, workers=8):
        ...
        self.model = LdaMallet(self.mallet_path, corpus_bow, num_topics=num_topics,id2word=self.dictionary, workers=workers, prefix="./"+model_name+"/")

    def save_model(self):
        self.model.save(self.model_name+"/model.model")
        self.dictionary.save(self.model_name+"/dict.dict")

    def load_model(self, model_name):
        self.model_name = model_name
        self.dictionary  = corpora.Dictionary.load(self.model_name+"/dict.dict")
        self.model = LdaMallet.load(self.model_name+"/model.model") 
